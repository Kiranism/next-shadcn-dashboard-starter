...
- **Шаги выполнения**:
  ...
  - [ ] Обновить `docs/api.md` под текущие эндпоинты
...
- **Шаги выполнения**:
  ...
  - [ ] Проверка влияния на код (`getUserByTelegramId` уже использует `findFirst`)
...
- **Шаги выполнения**:
  - [ ] Создать API-роут
  - [ ] Интегрировать с `ForgotPasswordView`
  - [ ] Написать тесты
...
- **Затраченное время**: [0] часов
- **Шаги выполнения**:
  - [ ] Провайдеры-адаптеры для каналов
  - [ ] CRUD шаблонов/настроек
  - [ ] Логи уведомлений
...
- **Затраченное время**: [0] часов
- **Шаги выполнения**:
  - [ ] Расчет periodReferrals / periodBonusPaid / averageOrderValue
  - [ ] Сбор utmSources
  - [ ] При необходимости индексы/изменения схемы
- **Зависимости**: Prisma
...
- **Затраченное время**: [0] часов
- **Шаги выполнения**:
  - [ ] Добавить сервис кеширования и инвалидации
  - [ ] Применить в `webhook.queue.ts` и аналитике
- **Зависимости**: Redis
