...
- **Затраченное время**: [0] часов
- **Шаги выполнения**:
  - [ ] Создать страницу `/dashboard/notifications` - глобальное управление уведомлениями
    - [ ] Показ истории всех отправленных уведомлений
    - [ ] Быстрая отправка массовых уведомлений
    - [ ] Настройки шаблонов уведомлений
    - [ ] Статистика по доставке
  - [ ] Создать страницу `/dashboard/settings` - системные настройки
    - [ ] Общие параметры системы
    - [ ] Настройки безопасности
    - [ ] Интеграции (Telegram, Email, SMS)
    - [ ] Уведомления системы
    - [ ] Резервное копирование
  - [ ] Создать страницу `/dashboard/billing` - управление подпиской
    - [ ] Текущий тарифный план
    - [ ] Использование ресурсов (проекты, пользователи, боты)
    - [ ] История платежей
    - [ ] Лимиты и квоты
    - [ ] Возможность смены тарифа
  - [ ] Обновить навигацию в левом меню
  - [ ] Создать соответствующие API endpoints
  - [ ] Обновить breadcrumbs для новых страниц
- **Зависимости**: Существующая система проектов, JWT аутентификация
- **Тестирование**: Проверить работу всех трех страниц, корректность навигации и функциональность
