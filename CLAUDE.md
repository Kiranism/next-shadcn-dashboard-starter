...
- **Forms** — TanStack Form `useForm` + shadcn `Field` primitives, exactly per the official shadcn TanStack Form doc: `form.Field` render props, `Field`/`FieldLabel`/`FieldError` anatomy, form-level Zod `onSubmit` validators
