...
export function ProjectIntegrationView({
  ...
  const widgetCode =
    widgetUrl !== ''
      ? '<script src="' + widgetUrl + '?v=28"></' + 'script>'
      : '';
          ...
          >
            ...
            >
              <Card className='overflow-hidden'>
                <CardHeader>
                  <CardTitle>Установка виджета</CardTitle>
                  <CardDescription>
                  ...
                  <Alert>
                    ...
                    <AlertDescription>
                      <ul className='mt-2 list-inside list-disc space-y-1'>
                        ...
                        <li>
                          Сохраняет реферальные метки{' '}
                          <code className='text-xs'>utm_ref</code> /{' '}
                          <code className='text-xs'>utm_org</code> и передаёт их
                          в формы регистрации (B2B)
                        </li>
                      </ul>
                    </AlertDescription>
                  </Alert>
