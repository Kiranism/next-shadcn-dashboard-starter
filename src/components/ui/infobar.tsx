...
function SidebarProvider({
  ...
  // Clear content and close sidebar when pathname changes
  React.useEffect(() => {
...
function Sidebar({
  ...
  return (
    <div
      ...
      style={
        {
          '--sidebar-transition-duration': isPathnameChanging ? '0ms' : '200ms'
        } as React.CSSProperties
      }
    >
      ...
      <div
        ...
        className={cn(
          'relative w-(--sidebar-width) bg-transparent transition-[width] duration-(--sidebar-transition-duration,200ms) ease-linear',
      ...
      <div
        ...
        className={cn(
          'absolute inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-(--sidebar-transition-duration,200ms) ease-linear md:flex',
          side === 'left'
