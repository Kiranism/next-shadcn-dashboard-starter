...
Enable an authenticated user to manage their personal activities from the individual dashboard page (`/dashboard/individual`). The user can create activities, view them per day via a monthly calendar, and edit or delete activities they own.
